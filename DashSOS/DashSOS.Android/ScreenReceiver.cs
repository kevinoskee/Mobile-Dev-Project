...
using System.IO;
[assembly: Dependency(typeof(DashSOS.Droid.ScreenReceiver))]
namespace DashSOS.Droid
{
    public class ScreenReceiver : BroadcastReceiver
    {
        public int count;
        string dbPath = Path.Combine(System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal), "DashSOS.db3");
